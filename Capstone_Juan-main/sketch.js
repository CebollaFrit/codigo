...
function preload(){
    ...
    sonic_run = loadAnimation("SonicRun1.png", "SonicRun2.png", "SonicRun3.png","SonicRun4.png");
...
function draw() {
    ...
    if (gameState==="play"){
        ...
        // Es para que el jugador salte cuando toque el suelo

        //if(keyDown("space")&&(sonic.isTouching(invisible_floor))){
